...
export class RegionMySuffixService {
    ...
    private resourceUrl = '/armory/api/regions';
    private resourceSearchUrl = '/armory/api/_search/regions';
     ...
     */
    private convertItemFromServer(json: any): RegionMySuffix {
        const entity: RegionMySuffix = Object.assign(new RegionMySuffix(), json);
        return entity;
    }
