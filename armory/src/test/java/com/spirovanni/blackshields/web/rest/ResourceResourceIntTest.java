...
public class ResourceResourceIntTest {
    ...
    private static final byte[] DEFAULT_RESOURCE_AVATOR = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_RESOURCE_AVATOR = TestUtil.createByteArray(2, "1");
    private static final String DEFAULT_RESOURCE_AVATOR_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_RESOURCE_AVATOR_CONTENT_TYPE = "image/png";
    ...
    public static Resource createEntity(EntityManager em) {
        Resource resource = new Resource()
            ...
            .resourceAvator(DEFAULT_RESOURCE_AVATOR)
            .resourceAvatorContentType(DEFAULT_RESOURCE_AVATOR_CONTENT_TYPE)
    ...
    public void createResource() throws Exception {
        ...
        assertThat(testResource.getResourceAvator()).isEqualTo(DEFAULT_RESOURCE_AVATOR);
        assertThat(testResource.getResourceAvatorContentType()).isEqualTo(DEFAULT_RESOURCE_AVATOR_CONTENT_TYPE);
    ...
    public void getAllResources() throws Exception {
        ...
        restResourceMockMvc.perform(get("/api/resources?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].resourceAvatorContentType").value(hasItem(DEFAULT_RESOURCE_AVATOR_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].resourceAvator").value(hasItem(Base64Utils.encodeToString(DEFAULT_RESOURCE_AVATOR))))
    ...
    public void getResource() throws Exception {
        ...
        restResourceMockMvc.perform(get("/api/resources/{id}", resource.getId()))
            ...
            .andExpect(jsonPath("$.resourceAvatorContentType").value(DEFAULT_RESOURCE_AVATOR_CONTENT_TYPE))
            .andExpect(jsonPath("$.resourceAvator").value(Base64Utils.encodeToString(DEFAULT_RESOURCE_AVATOR)))
    ...
    public void updateResource() throws Exception {
        ...
        updatedResource
            ...
            .resourceAvator(UPDATED_RESOURCE_AVATOR)
            .resourceAvatorContentType(UPDATED_RESOURCE_AVATOR_CONTENT_TYPE)
        ...
        assertThat(testResource.getResourceAvator()).isEqualTo(UPDATED_RESOURCE_AVATOR);
        assertThat(testResource.getResourceAvatorContentType()).isEqualTo(UPDATED_RESOURCE_AVATOR_CONTENT_TYPE);
