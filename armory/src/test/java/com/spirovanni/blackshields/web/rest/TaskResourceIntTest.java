...
public class TaskResourceIntTest {
    ...
    private static final String DEFAULT_ELEMENT_ID = "AAAAAAAAAA";
    private static final String UPDATED_ELEMENT_ID = "BBBBBBBBBB";
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getElementID()).isEqualTo(DEFAULT_ELEMENT_ID);
        assertThat(testTask.getElementName()).isEqualTo(DEFAULT_ELEMENT_NAME);
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getElementID()).isEqualTo(UPDATED_ELEMENT_ID);
        assertThat(testTask.getElementName()).isEqualTo(UPDATED_ELEMENT_NAME);
