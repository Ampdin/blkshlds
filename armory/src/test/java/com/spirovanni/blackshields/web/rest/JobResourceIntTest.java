...
public class JobResourceIntTest {
    ...
    private static final Long DEFAULT_ONET_CODE = 1L;
    private static final Long UPDATED_ONET_CODE = 2L;
    ...
    public void createJob() throws Exception {
        ...
        assertThat(testJob.getOnetCode()).isEqualTo(DEFAULT_ONET_CODE);
    ...
    public void getJob() throws Exception {
        ...
        restJobMockMvc.perform(get("/api/jobs/{id}", job.getId()))
            ...
            .andExpect(jsonPath("$.onetCode").value(DEFAULT_ONET_CODE.intValue()))
    ...
    public void updateJob() throws Exception {
        ...
        assertThat(testJob.getOnetCode()).isEqualTo(UPDATED_ONET_CODE);
