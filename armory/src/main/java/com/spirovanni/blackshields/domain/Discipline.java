...
public class Discipline implements Serializable {
    ...
    @Lob
    @Column(name = "discipline_avator")
    private byte[] disciplineAvator;

    @Column(name = "discipline_avator_content_type")
    ...
    public Discipline disciplineAvator(byte[] disciplineAvator) {
    ...
    public Discipline disciplineAvatorContentType(String disciplineAvatorContentType) {
    ...
    public Discipline employees(Set<Employee> employees) {
        this.employees = employees;
        return this;
    }

    public Discipline addEmployee(Employee employee) {
        this.employees.add(employee);
        employee.setDiscipline(this);
        return this;
    }

    public Discipline removeEmployee(Employee employee) {
    ...
    public String toString() {
        return "Discipline{" +
            ...
            ", disciplineAvatorContentType='" + getDisciplineAvatorContentType() + "'" +
